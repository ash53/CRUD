...
namespace Rti.RemoteProcedureCalls.Embillz
{
    ...
    public class GetR2PList : RpcBase
    {
        //parameters
        ...
        //    : base()
        public GetR2PList(GetRemitItemsInputParams inputParams)
            : base()
        {
            SetDefaultParameters();
        ...
        public void SetInputParameters()
        {
            try
            {
                SetInputParameter("rstatus_flag", strStatusFlag);
        ...
        /// </remarks>
        /// </summary>
        new public GetRemitItemsResults1 CallRPC()
        {
            var rpcResult = new GetRemitItemsResults1();
            try
            {
                ...
                //Process results
                resultSet = base.Results.getResultSet("outremit2post");
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    rpcResult.RemitItems = ds.Tables["RemitInfo"];
                }
