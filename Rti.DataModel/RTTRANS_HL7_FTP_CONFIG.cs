...
namespace Rti.DataModel
{
    ...
    public partial class RTTRANS_HL7_FTP_CONFIG
    {
        ...
        public Nullable<int> FINANCIALCLASS { get; set; }
        public Nullable<decimal> DAYSLAG { get; set; }
        public string LOGINDICATOR { get; set; }
        public Nullable<decimal> PRIORITY { get; set; }
        public Nullable<decimal> PRIORITY1 { get; set; }
    }
}
